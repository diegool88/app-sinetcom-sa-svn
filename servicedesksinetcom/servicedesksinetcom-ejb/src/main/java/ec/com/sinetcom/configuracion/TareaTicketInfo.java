 ...
 * @author diegoflores
 */
public class TareaTicketInfo implements Serializable{
    ...
    public TareaTicketInfo()
    {
        this("<Job ID>", "<Job Name>", "java:global/servicedesksinetcom-ear/servicedesksinetcom-ejb-1/", null);
    }

    public TareaTicketInfo(String jobId, String jobName, String jobClassName, Ticket ticket)
    {
        this.jobId = jobId;
    ...
    {
        if (anotherObj instanceof TareaTicketInfo)
        {
            return jobId.equals(((TareaTicketInfo) anotherObj).jobId);
        }
        return false;
    }
