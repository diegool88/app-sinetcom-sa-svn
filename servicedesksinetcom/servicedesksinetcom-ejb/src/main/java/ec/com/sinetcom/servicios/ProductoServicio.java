...
import ec.com.sinetcom.dao.HistorialDeContratosYEquiposFacade;
...
public class ProductoServicio {
    ...
    @EJB
    private HistorialDeContratosYEquiposFacade contratosYEquiposFacade;
    ...
    /**
     * Obtiene todos los registros de movimiento de inventario que están
     * completos
     *
     * @return
     */
    ...
    /**
     * Servicio que obtiene todos los productos padre por modelo, exectuando a
     * los atómicos
     *
    ...
    /**
     * Servicio que obtiene todos los productos padre de un contrato
     * @param contrato
     * @return 
     */
    public List<ItemProducto> obtenerTodosLosProductosPadreDeUnContrato(Contrato contrato){
        return this.itemProductoFacade.obtenerTodosLosProductosPadreDeUnContrato(contrato);
    }
    
    /**
     * Servicio que obtiene todos los productos padre dentro del stock local
     * @return 
     */
    public List<ItemProducto> obtenerTodosLosProductosPadresDeStockLocal(){
        return this.itemProductoFacade.obtenerTodosLosProductosPadreDeStockLocal();
    }
    /**
    ...
    /**
     * Servicio que obtiene todas las lineas de prodcuto por categoria y
     * fabricante
     *
     * @param fabricante
     * @param categoriaProducto
    ...
    /**
     * Obtiene todo el inventario disponible en bodega local incluyendo las
     * partes dañadas
     *
     * @return
     */
    ...
    public boolean ingresarNuevoProductoComponenteAtomico(ItemProducto itemProducto, List<AtributoItemProducto> atributos) {
        try {
            ...
            //Para llevar el historial de los equipos y los contratos
            if (itemProducto.getContratonumero() != null) {
                HistorialDeContratosYEquipos contratosYEquipos = new HistorialDeContratosYEquipos();
                contratosYEquipos.setFechaDeEntregaRecepcion(itemProducto.getContratonumero().getFechaDeEntregaRecepcion());
                contratosYEquipos.setContratonumero(itemProducto.getContratonumero());
                contratosYEquipos.setItemProductonumeroSerial(itemProducto);
                this.contratosYEquiposFacade.create(contratosYEquipos);
            }
    ...
    /**
     * Ingresa el historial de los equipos y contratos
     * @param itemProducto
     * @param contrato
     * @return 
     */
    public boolean crearRegistroDeHistorialDeEquiposYContratos(ItemProducto itemProducto, Contrato contrato){
        try{
            HistorialDeContratosYEquipos contratosYEquipos = new HistorialDeContratosYEquipos();
            contratosYEquipos.setContratonumero(contrato);
            contratosYEquipos.setItemProductonumeroSerial(itemProducto);
            contratosYEquipos.setFechaDeEntregaRecepcion(contrato.getFechaDeEntregaRecepcion());
            this.contratosYEquiposFacade.create(contratosYEquipos);
            return true;
        }catch(Exception e){
            e.printStackTrace();
