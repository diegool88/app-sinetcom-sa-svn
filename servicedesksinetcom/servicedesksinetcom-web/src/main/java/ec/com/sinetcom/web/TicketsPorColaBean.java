 ...
 * @author diegoflores
 */
@ManagedBean(name = "ticketsPorCola")
@ViewScoped
public class TicketsPorColaBean extends BotonesTickets implements Serializable {
    ...
    public void doInit() {
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaCola(null, 1);
    ...
    public void recargarTablaTickets(){
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaCola(null, tabSeleccionadoIndex + 1);
    }
    ...
    public void cambioDeTab(TabChangeEvent event) {
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaCola(null, seleccion);
        this.articulos = null;
    ...
    public void cerrarCaso(ActionEvent event) {
        ...
        if (!tieneActividades) {
            ...
            this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaCola(null, this.ticketSeleccionado.getColaid().getId());
