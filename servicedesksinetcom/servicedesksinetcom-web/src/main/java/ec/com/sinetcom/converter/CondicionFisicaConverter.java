...
@ManagedBean(name="condicionFisicaConverter")
public class CondicionFisicaConverter implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if(value != null && value.trim().length() > 0){
            return this.productoServicio.obtenerCondicionFisicaPorId(Integer.parseInt(value));
        }else{
            return null;
        }
