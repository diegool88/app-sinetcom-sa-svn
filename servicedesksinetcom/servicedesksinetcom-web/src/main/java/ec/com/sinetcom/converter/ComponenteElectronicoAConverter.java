...
@ManagedBean(name="componenteElectronicoAConverter")
public class ComponenteElectronicoAConverter implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if(value != null && value.trim().length() > 0){
            return this.productoServicio.obtenerComponenteElectronicoAPorId(Integer.parseInt(value));
        }else{
            return null;
        }
