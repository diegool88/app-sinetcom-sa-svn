 ...
 * @author diegoflores
 */
public class TareaCursoInfo implements Serializable{
    ...
    public TareaCursoInfo()
    {
        this("<Job ID>", "<Job Name>", "java:global/servicedesksinetcom-ear/servicedesksinetcom-ejb-1/", null);
    }

    public TareaCursoInfo(String jobId, String jobName, String jobClassName, Curso curso)
    {
        this.jobId = jobId;
    ...
    {
        if (anotherObj instanceof TareaCursoInfo)
        {
            return jobId.equals(((TareaCursoInfo) anotherObj).jobId);
        }
        return false;
    }
