 ...
 * @author diegoflores
 */
@ManagedBean(name="ticketsPorPrioridad")
@ViewScoped
public class TicketsPorPrioridadBean extends BotonesTickets implements Serializable{
    ...
    public void doInit() {
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaPrioridad(null, 1);
    ...
    public void recargarTablaTickets(){
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaPrioridad(null, tabSeleccionadoIndex + 1);
    }
    ...
    public void cambioDeTab(TabChangeEvent event) {
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaPrioridad(null, seleccion);
        this.articulos = null;
    ...
    public void cerrarCaso(ActionEvent event) {
        ...
        if (!tieneActividades) {
            ...
            this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnaPrioridad(null, this.ticketSeleccionado.getPrioridadTicketcodigo().getCodigo());
