 ...
 * @author diegoflores
 */
@ManagedBean(name="ticketsPorEstado")
@ViewScoped
public class TicketsPorEstadoBean extends BotonesTickets implements Serializable{
    ...
    public void doInit() {
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnEstado(null, 1);
    ...
    public void cambioDeTab(TabChangeEvent event) {
        ...
        this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnEstado(null, seleccion);
        this.articulos = null;
    ...
    public void cerrarCaso(ActionEvent event) {
        ...
        if (!tieneActividades) {
            ...
            this.tickets = this.ticketServicio.obtenerTodosLosTicketsPorUnEstado(null, this.ticketSeleccionado.getEstadoTicketcodigo().getCodigo());
